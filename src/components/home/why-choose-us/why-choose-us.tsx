      ...
      <div className="mx-auto flex w-11/12 flex-col items-center lg:w-10/12">
        ...
        <div className="relative mt-[34px] flex w-full max-w-2xl items-center justify-center">
          <div className="flex w-full max-w-[520px] flex-col gap-3 sm:flex-row sm:gap-6">
            <div className="bg-gradient-to-r from-[#D1D1D173] to-[#D1D1D11F] flex h-[40px] w-full items-center gap-[8px] rounded-full px-[18px] font-semibold text-[#171717] text-base sm:w-[250px] sm:rounded-l-full sm:rounded-r-none sm:text-lg">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1353_12460)">
                  <path d="M3.75 16.5H14.25" stroke="#161515" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M3.75 1.5H14.25" stroke="#161515" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M12.75 16.5V13.371C12.7499 12.9732 12.5918 12.5917 12.3105 12.3105L9 9L5.6895 12.3105C5.40818 12.5917 5.25008 12.9732 5.25 13.371V16.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M5.25 1.5V4.629C5.25008 5.02679 5.40818 5.40826 5.6895 5.6895L9 9L12.3105 5.6895C12.5918 5.40826 12.7499 5.02679 12.75 4.629V1.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>

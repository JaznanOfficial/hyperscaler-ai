    ...
    <section className="relative w-full overflow- bg-white">
      ...
      <div className="  mx-auto">
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center max-sm:mt-20 max-sm:items-center">
            {/* Pill tagline */}
          ...
          <div className="relative h-full w-full max-sm:pt-10">
            <Image

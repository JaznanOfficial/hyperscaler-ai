...
const clientQuickActions = [
  {
    ...
    description:
      "Review performance highlights and quick wins across your active services.",
    prompt: "Show me today's performance highlights across my services.",
    icon: Compass,
  },
  {
    title: "Growth Opportunities",
    description:
      "Identify the best channels to invest in next based on recent trends.",
    prompt: "Which channels should I invest in next?",
    icon: RefreshCw,
  },
  {
    title: "Executive Summary",
    description:
      "Generate an executive-ready summary for your weekly stakeholder update.",
    prompt: "Draft my weekly executive summary for stakeholders.",
    icon: Rocket,
  },
] as const;

export function ClientAgentEmptyState({
  draft,
  onDraftChange,
  onSubmit,
  textareaRef,
      ...
      <div className="flex w-full max-w-3xl flex-col items-center gap-7">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-base text-slate-600 leading-6">
            What would you like to explore about your growth today?
          </p>
        </div>
        <form

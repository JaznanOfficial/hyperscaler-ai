...
const employeeQuickActions = [
  {
    ...
    description:
      "Summarize today's blockers, escalations, and progress across your tasks.",
    prompt: "Summarize today's blockers and progress for my projects.",
    icon: Compass,
  },
  {
    title: "Next Actions",
    description:
      "Get a prioritized action list and suggested follow-ups for the day.",
    prompt: "What should I focus on next today?",
    icon: RefreshCw,
  },
  {
    title: "Stand-up Prep",
    description: "Create a quick stand-up summary and flag any help you need.",
    prompt: "Prep my stand-up summary with risks and asks.",
    icon: Rocket,
  },
] as const;

export function EmployeeAgentEmptyState({
  draft,
  onDraftChange,
  onSubmit,
  textareaRef,
      ...
      <div className="flex w-full max-w-3xl flex-col items-center gap-7">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-base text-slate-600 leading-6">
            What can I help you get done today?
          </p>
        </div>
        <form

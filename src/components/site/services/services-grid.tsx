  ...
  return (
    <div className="flex flex-wrap justify-center gap-5 md:gap-6">
      {services.map((service) => (
        <div
          className="flex w-full max-w-[420px] flex-1 md:basis-[calc(50%-12px)] xl:basis-[calc(33.333%-16px)]"
          key={service.id}
        >
          <Card className="relative flex h-full w-full flex-col justify-between border border-slate-200 bg-white p-5 shadow-[0_12px_30px_rgba(12,10,44,0.05)]">

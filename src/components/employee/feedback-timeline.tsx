    ...
    <Card className="h-full border-slate-200/70">
      <CardHeader>
        <CardTitle className="font-semibold text-lg text-slate-900">
          Latest feedback loops
        </CardTitle>
        <CardDescription>
          Signals synced from the last 24 hours.
        </CardDescription>
      </CardHeader>
          ...
          <div className="flex items-start gap-3" key={entry.id}>
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge
                  className="rounded-full border-slate-200 px-2 py-0 text-[10px] uppercase tracking-wide"
                  variant="outline"
                >
                  {entry.category}
                </Badge>
              ...
              <p className="mt-2 font-medium text-slate-400 text-xs">
                {entry.time}
              </p>
            </div>
          </div>

...
const FIELDS: Array<{ id: string; label: string; suffix?: string }> = [
  { id: "connections_sent", label: "Connection requests sent" },
  { id: "connections_accepted", label: "Connection requests accepted" },
  { id: "messages_sent", label: "Messages sent" },
  { id: "reply_rate", label: "Reply rate", suffix: "%" },
  { id: "positive_reply_rate", label: "Positive reply rate", suffix: "%" },
  { id: "qualified_leads", label: "Qualified leads" },
  { id: "meetings_booked", label: "Meetings booked" },
];

export function LinkedinOutreachStatisticsInput({
  defaultValues,
  onChange,
  selectedDate,
  serviceId,

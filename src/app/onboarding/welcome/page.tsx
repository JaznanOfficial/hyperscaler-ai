...
const sidebarPreviewImage =
    "/onboarding/Hyperscaler-Onboarding.gif";
...
export default function WelcomePage() {
    return (
        <main className="bg-white min-h-svh w-full lg:grid lg:grid-cols-[minmax(420px,40%)_1fr]">
            <section className="relative hidden m-4 overflow-hidden rounded-3xl bg-[#EBDDFA] lg:block">
                ...
                <img
                    alt=""
                    aria-hidden="true"
                    className="absolute -right-[70%] top-1/2 hidden h-[92%] -translate-y-1/2 rounded-2xl object-cover opacity-50 xl:block"
                ...
                <div className="flex w-full max-w-[560px] flex-col items-center gap-12 text-center">
                    <div className="flex flex-col items-center gap-8">
                        <div className="flex items-center gap-2">
                            <Image src="/logo.png" alt="Hyperscaler" width={200} height={200} priority/>
                        </div>
                    ...
                    <div className="flex w-full max-w-[292px] flex-col items-center gap-4">
                        <Button className="h-[52px] w-full" size="lg" type="button" variant="gradient">
                            Let&apos;s Get Started

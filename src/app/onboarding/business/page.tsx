            ...
            <section className="flex min-h-svh justify-center px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
                <div className="w-full max-w-[760px]">
                    ...
                    <div className="mb-10 space-y-2">
                        <h1 className="font-['Outfit'] font-medium text-[#1A1A1A] text-3xl leading-[1.5] sm:text-[32px]">
                    ...
                    <form className="space-y-7">
                        <div className="space-y-3">
                            <label className="font-normal text-[#1A1A1A] text-base" htmlFor="business-name">
                                Business Name
                            </label>
                            <Input
                        ...
                        <div className="space-y-3">
                            <label className="font-normal text-[#1A1A1A] text-base" htmlFor="industry">
                                Industry/ Niche
                            </label>
                        ...
                        <div className="space-y-3">
                            <p className="font-normal text-[#1A1A1A] text-base">Business Stage</p>
                            <div className="flex flex-wrap gap-4">
                                {STAGES.map((stage) => {
                                    const isSelected = selectedStage === stage;
                                    return (
                                        <button
                                            className={`h-9 rounded-full border px-6 font-medium text-sm transition-colors ${isSelected
                        ...
                        <div className="space-y-3">
                            <p className="font-normal text-[#1A1A1A] text-base">
                                Monthly Revenue Range <span className="opacity-60">(optional)</span>
                            </p>

...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: `You are Hyperscaler AI, built by Scale Build AI. you're a helpful sales assistant. you'll give the information about Hyperscaler and Scale Build AI and our services, we provide. those are:-
